...
export default function Header() {
  ...
  `}
    >
      <div
        className="max-w-screen mx-auto h-24 flex items-center justify-between px-15 "
        style={{ font: "Archivo" }}
      >
        {/* Logo */}
        <Link href="/">
        ...
        <div className="relative pt-8">
          <nav className="hidden lg:flex items-center gap-12 text-white">
            <button
              className="border-b border-b-transparent hover:border-white pb-2"
              onMouseEnter={() => {
                setOpenMenu(null);
              }}
            >
            ...
            <div className="flex items-center gap-4 text-white">
              ...
              <div className="relative group">
                <button className=" mb-2 p-2.5 rounded-full hover:bg-white/10 transition-colors flex items-center justify-center">
              ...
              {openMenu === "about" && (
                <div className="pb-6">
                  ...
                  <div className="grid grid-cols-3 gap-8 mt-6">
                    <div className="flex flex-col gap-2 items-start font-light text-sm ">
                      <button className=" hover:text-amber-300">Pheonix</button>
                      <button className=" hover:text-amber-300">
                        Values and Purpose
                      </button>
                      <button className=" hover:text-amber-300">
